...
----	
This below annotation flag your Junit class as a Test using CA Virtual Services. This annotation set the configuration of CA DevTest Server. you can set up :
